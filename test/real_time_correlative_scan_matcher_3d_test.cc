...
#include "cartographer_stripped/mapping/scan_matching/real_time_correlative_scan_matcher_options.h"
...
#include "cartographer_stripped/transform/rigid_transform_test_helpers.h"
